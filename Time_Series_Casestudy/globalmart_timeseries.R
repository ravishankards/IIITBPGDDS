######### Global superstore Time series assignment #########
# Our Objective 
...
# However we will removing postal codes since it doesnt have any significance
...
## Outlier Checks - There are few outliers, but we wont remove them since they refelect real time flucatuation in sales and demand over a period of time

boxplot(AF1$Monthly.Sales)
boxplot(AF2$Monthly.Sales)
boxplot(AF3$Monthly.Sales)

boxplot(APAC1$Monthly.Sales)
boxplot(APAC2$Monthly.Sales)
boxplot(APAC3$Monthly.Sales)

boxplot(CAN1$Monthly.Sales)
boxplot(CAN2$Monthly.Sales)
boxplot(CAN3$Monthly.Sales)

boxplot(EMEA1$Monthly.Sales)
boxplot(EMEA2$Monthly.Sales)
boxplot(EMEA3$Monthly.Sales)

boxplot(EU1$Monthly.Sales)
boxplot(EU2$Monthly.Sales)
boxplot(EU3$Monthly.Sales)

boxplot(LATM1$Monthly.Sales)
boxplot(LATM2$Monthly.Sales)
boxplot(LATM3$Monthly.Sales)

boxplot(US1$Monthly.Sales)
boxplot(US2$Monthly.Sales)
boxplot(US3$Monthly.Sales)

boxplot(AF1$Monthly.Demand)
boxplot(AF2$Monthly.Demand)
boxplot(AF3$Monthly.Demand)

boxplot(APAC1$Monthly.Demand)
boxplot(APAC2$Monthly.Demand)
boxplot(APAC3$Monthly.Demand)

boxplot(CAN1$Monthly.Demand)
boxplot(CAN2$Monthly.Demand)
boxplot(CAN3$Monthly.Demand)

boxplot(EMEA1$Monthly.Demand)
boxplot(EMEA2$Monthly.Demand)
boxplot(EMEA3$Monthly.Demand)

boxplot(EU1$Monthly.Demand)
boxplot(EU2$Monthly.Demand)
boxplot(EU3$Monthly.Demand)

boxplot(LATM1$Monthly.Demand)
boxplot(LATM2$Monthly.Demand)
boxplot(LATM3$Monthly.Demand)

boxplot(US1$Monthly.Demand)
boxplot(US2$Monthly.Demand)
boxplot(US3$Monthly.Demand)
...
adf.test(resi,alternative = "stationary") # Dickey-Fuller = -4.8164, Lag order = 3, p-value = 0.01
kpss.test(resi) #KPSS Level = 0.030444, Truncation lag parameter = 1, p-value = 0.1
plot(resi)
...
#Let us forecast the Demand using for AR_dmd_APAC1 next 6 months 
Predict_sales_APAC1<- predict(AR_sales_APAC1, n.ahead = 6)
...
adf.test(resi,alternative = "stationary") # Dickey-Fuller = -3.8698, Lag order = 3, p-value = 0.02438
kpss.test(resi) # KPSS Level = 0.025159, Truncation lag parameter = 1, p-value = 0.1
...
## sigma^2 estimated as 102877099:  log likelihood=-447.03
## AIC=896.05   AICc=896.15   BIC=897.79
...
adf.test(resi_2,alternative = "stationary")# Dickey-Fuller = -4.9062, Lag order = 3, p-value = 0.01
kpss.test(resi_2)# KPSS Level = 0.024222, Truncation lag parameter = 1, p-value = 0.1
